    ...
    return (
        <div className="card w-96 bg-blue-200 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className='text-lg mb-6 break-words'><span className='font-bold'>Description:<br /></span> 🖋️ {product.description}</p>
                ...
                <div className="card-actions bg-blue-300 p-2 rounded-2xl">
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                            <img src="https://glenfarrow.co.uk/wp-content/uploads/User-icon.png" alt="" className='w-1/4' />
                            <div>
                        ...
                        <label htmlFor="book-modal" className="btn btn-primary font-bold" onClick={() => setModals(product)}>Book Now !</label>
